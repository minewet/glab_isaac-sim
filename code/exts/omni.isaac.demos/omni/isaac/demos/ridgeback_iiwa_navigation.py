...
EXTENSION_NAME = "Ridgeback Iiwa Navigation"
...
class Extension(omni.ext.IExt):
    ...
    async def _create_robot(self, task):
        ...
        if task in done:
            ...
            if current_robot_index == 0:
                ...
                robot_usd = "C:/Users/kimhj/Downloads/sk/ridgeback_iiwa/ridgeback_iiwa.usd"
                self._robot_chassis = self._robot_prim_path + "/chassis_link"
                self._robot_wheels = ["front_left_wheel", "front_right_wheel"]
                self._robot_wheels_speed = [20, 20]
                self._wheelbase_Length = 4.4744
                self._wheel_radius = 0.00332
    ...
    def _on_move_fn(self):
        ...
        self._rc.control_command(10, 10)

    def _on_rotate_fn(self):
        print("Rotating in-place")
        self._rc.control_command(20, -20)
